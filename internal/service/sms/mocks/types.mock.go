...
func (m *MockService) Send(ctx context.Context, tplId string, params []string, phoneNumbers ...string) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Send(ctx, tplId, params any, phoneNumbers ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, tplId, params}, phoneNumbers...)
